...
The goal of fedeconseries is to obtain US federal reserve economic data.  Reserach use only.
...
## Usage
A more detailed example can be found in my vignette: https://harrysun26.github.io/fedeconseries/articles/the_Vignettes.html
